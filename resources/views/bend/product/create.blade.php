                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-title">
                                <div>
                                    <span class="float-left"><strong class="btn font-weight-bold">Add New
                                            Product</strong></span>
                                    <span class="float-right"><a href="{{url('/shopping/products')}}"
                                            class="btn btn-info"><i class="fa fa-bars text-white"></i> <span
                                                class="d-none d-md-inline">&nbsp;List all Products</span></a></span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="negotiable"
                                                    id="negotiable1" value="1">
                                                <label class="form-check-label" for="negotiable1">Yes </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="negotiable"
                                                    id="negotiable2" value="0">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" value="{{old('category_id')}}" class="selectpicker"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="price" value="{{old('price')}}" type="number" class="form-control"
                                            placeholder="In Nepali Rupeese (Only Number)">
                                    </div>
                                    <div class="form-group">
                                        <label>Is Warranty ?</label>
                                        <div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="warrenty_status"
                                                    id="warrenty_status1" value="yes">
                                                <label class="form-check-label" for="warrenty_status1">Yes </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="warrenty_status"
                                                    id="warrenty_status2" value="no">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" name="details" value="{{old('details')}}" type="text"
                                            class="form-control" placeholder="Product Discription"></textarea>
                                        <input type="hidden" name="media_id">
                                        <br>
                                        <div id="dropZone" class="dropzone">
                                            <div class="dz-default dz-message">
                                                <h3>{{ $title ?? 'Drop files here or click to upload.'}}</h3>
                                                <p class="text-muted">{{ $desc ??'Any related files you can upload' }}
                                                    <br>
                                                    <small>One file can be max
                                                        {{ config('attachment.max_size', 0) / 1000 }} MB</small>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
<script src="/lib/dropzone/app.js"></script>
