                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <span class="float-right"><a href="{{url('action/categories/create')}}" class="btn btn-info"><i class="fa fa-plus text-white"></i> <span class="d-none d-md-inline">&nbsp;Add New Category</span></a></span>
                        </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center  text-nowrap" style="width:120px">
                                        ...
                                        <a href="{{url('categories/'.$item->id.'/edit')}}" class="btn btn-outline-primary">
